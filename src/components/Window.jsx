...
function Window(props) {
  ...
  return (
    <WindowContent ref={domNode} style={{ top, left, zIndex: layer }} onMouseDown={activate} className="box blockhover">
      <div
      ...
      >
        ...
        <span style={{ cursor: "crosshair" }} onMouseDown={props.close}>
          X
        </span>
      </div>
      {props.children}
